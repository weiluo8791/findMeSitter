...
<html>
    ...
    <body>
        ...
        <div id="show-calendar" class="content scaffold-show" role="main">
            ...
            <f:display bean="calendar" />
            <g:form resource="${this.calendar}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.calendar}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
