...
<html>
    ...
    <body>
        ...
        <div id="show-feature" class="content scaffold-show" role="main">
            ...
            <f:display bean="feature" />
            <g:form resource="${this.feature}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.feature}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
