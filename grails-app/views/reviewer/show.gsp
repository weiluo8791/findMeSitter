...
<html>
    ...
    <body>
        ...
        <div id="show-reviewer" class="content scaffold-show" role="main">
            ...
            <f:display bean="reviewer" />
            <g:form resource="${this.reviewer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.reviewer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
